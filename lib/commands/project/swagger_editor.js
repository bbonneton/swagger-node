...
function edit(project, options, cb) {
  ...
  // serve the folder that contains the files referenced into the swagger file
  app.use(SWAGGER_EDITOR_SERVE_PATH+config.swagger.yamlReferencedFilesFolder, serveStatic(path.resolve(project.dirname, config.swagger.yamlReferencedFilesFolder)));
